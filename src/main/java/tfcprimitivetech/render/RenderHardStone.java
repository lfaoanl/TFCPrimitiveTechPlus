...
public class RenderHardStone extends Render
{
	...
	{
		this.render((EntityProjectileHardStone)par1Entity, par2, par4, par6, par8, par9);
	}

	@Override
	protected ResourceLocation getEntityTexture(Entity entity) 
	{
		return new ResourceLocation(ModDetails.ModID, "textures/models/hardstone.png");
	}
}
