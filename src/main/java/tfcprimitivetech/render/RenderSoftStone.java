...
public class RenderSoftStone extends Render
{
	...
	{
		this.render((EntityProjectileSoftStone)par1Entity, par2, par4, par6, par8, par9);
	}

	@Override
	protected ResourceLocation getEntityTexture(Entity entity) 
	{
		return new ResourceLocation(ModDetails.ModID, "textures/models/softstone.png");
	}
}
