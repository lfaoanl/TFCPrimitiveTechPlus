...
public class EntityProjectileHardStone extends EntityProjectileStone 
{
	
	public Item pickupItem = ModItems.itemHardStone;	
	
	public EntityProjectileHardStone(World par1World)
	{
		super(par1World);
	}

	public EntityProjectileHardStone(World par1World, double i, double j, double k)
	{
		super(par1World, i , j, k);
	}

	public EntityProjectileHardStone(World world, EntityLivingBase shooter, EntityLivingBase victim, float force, float forceVariation)
	{
		super(world, shooter, victim, force * 1.1F, forceVariation);
	}

	public EntityProjectileHardStone(World par1World, EntityLivingBase shooter, float force)
	{
